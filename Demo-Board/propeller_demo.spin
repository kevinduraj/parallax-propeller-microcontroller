...
VAR
  ...
  long  mousex, mousey, mousex2, mousey2
...
PUB start | i, j, k, kk, dx, dy, pp, pq, rr, numx, numchr
  ...
  repeat
    ...
    'draw expanding mouse crosshairs
    gr.colorwidth(2,(k+32)>>2)
    mousex2 := mousex2 + mouse[1].delta_x #> -128 <# 127
    mousey2 := mousey2 + mouse[1].delta_y #> -96 <# 95
    gr.pix(mousex2, mousey2, 0, @pixdef2)
