...
PUB MyWatch | cog3
  ...
  repeat
    ...
    if minutes == 0
      ! outa[LED_END]
    elseif minutes > 10
      outa[LED_START..LED_END]~
    else
      outa[LED_START..LED_END] := minutes

    if minutes > 14
      ! outa[LED_START]
      outa[LED_START+1] := ! outa[LED_START]
      outa[LED_START+2] := ! outa[LED_START+1]
      outa[LED_START+3] := ! outa[LED_START+2]
      outa[LED_START+4] := ! outa[LED_START+3]
    elseif minutes > 12
      ! outa[LED_START]
      outa[LED_START+1] := ! outa[LED_START]
      outa[LED_START+2] := ! outa[LED_START+1]
